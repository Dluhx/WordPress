...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      submit_button( esc_html__( '保存', 'cs-framework' ), 'primary cs-save', '保存', false, array( 'data-save' => esc_html__( '保存中...', 'cs-framework' ) ) );
      submit_button( esc_html__( '恢复默认设置', 'cs-framework' ), 'secondary cs-restore cs-reset-confirm', $this->unique .'[reset]', false );
      ...
      echo '<div class="cs-block-right">&copy; '.date('Y').' Theme By <a href="https://wpmes.cn" target="_blank" style="color: #555;text-decoration: none;">wpmes.cn</a> </div>';
      echo '<div class="clear"></div>';
