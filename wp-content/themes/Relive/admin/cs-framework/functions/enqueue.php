...
if( ! function_exists( 'cs_admin_enqueue_scripts' ) ) {
  function cs_admin_enqueue_scripts() {
    ...
    wp_enqueue_style( 'font-awesome', CS_URI .'/assets/css/font-awesome.min.css', array(), '4.7.0', 'all' );
	wp_enqueue_style( 'iconfont', get_bloginfo('template_directory') .'/static/font/iconfont.css', array(), 'xintheme', 'all' );
