...
class ColorfulCategories
{
    ...
    public function admin_enqueue_scripts($screen)
    {
        if('edit-tags.php' === $screen) {
            ...
            wp_enqueue_script('color-category', get_stylesheet_directory_uri() .'/admin/colorful-categories/admin-colorful-categories.js', null, null, true);
    ...
    {
        return array_slice($column, 0, 2, true) + array('color' => __('选择颜色', 'colorful-categories')) + array_slice($column, 2, null, true);
    }
    ...
    public function modifyColumn($null, $columnName, $termId)
    {
        ...
        echo '<span class="colorful-categories-saving" style="display: none;">' . __('保存中...', 'colorful-categories') . '</span>';
    }
    ...
    {
        require_once TEMPLATEPATH.'/admin/colorful-categories/widget.php';
