...
class ColorfulCategoriesWidget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            __('分类目录和标签', 'colorful-categories'),
            array('description' => __('彩色分类目录以及标签云', 'colorful-categories'))
        );
    }
    ...
    protected function getThemes()
    {
        return apply_filters('colorful_categories_themes', array(
            'box'    => __('常规样式', 'colorful-categories'),
			'bubble' => __('圆角背景', 'colorful-categories'),
			''       => __('没有样式', 'colorful-categories')
        ));
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('taxonomy'); ?>"><?php _e( '选择类型：', 'colorful-categories' ); ?></label><br />
        ...
        <label for="<?php echo $this->get_field_id('empty'); ?>"><?php _e( '显示空栏目（指没有文章的类目）', 'colorful-categories' ); ?></label><br />

        <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>"<?php checked( $count ); ?> />
        <label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( '显示文章数量', 'colorful-categories' ); ?></label><br />

        <p>
            <label for="<?php echo $this->get_field_id('theme'); ?>"><?php _e( '选择样式', 'colorful-categories' ); ?></label><br />
        ...
        <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e( '限制显示数量（0 表示无限制）：', 'colorful-categories' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('excluded'); ?>"><?php _e( '排除类别ID（多个ID用英文逗号隔开）：', 'colorful-categories' ); ?></label>
            <br />
    ...
    {
        $title = apply_filters('widget_title', empty($instance['title']) ? __('类别小工具', 'colorful-categories') : $instance['title'], $instance, $this->id_base);
