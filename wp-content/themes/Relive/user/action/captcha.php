...
if($_POST['action'] == 'XinTheme_captcha' && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
...
function sessioncode($email){
	...
	$_SESSION['XinTheme_captcha']=strtolower($_dscode);
	$_SESSION['XinTheme_captcha_email']=$email;
	$message .= '验证码：'.$_dscode;   
