...
<div class="<?php if( $id['modular_list_mobile'] ){ ?>mobile_modular_no <?php } ?>mnmd-block<?php if( $full_background_white ){?> relive_v3<?php }?>">
	...
	<div class="row row--space-between">
		<?php
			query_posts('cat='.$exclude_id.'&posts_per_page=5&ignore_sticky_posts=1&orderby=date');
			$i = 1;
		...
		<div class="col-xs-12 col-sm-4">
			<ul class="list-space-xs list-seperated-exclude-first list-square-bullet-exclude-first list-unstyled">
				<li><article class="xin_hover post post--vertical ">
				<div class="post__thumb min-height-170">
					<a href="<?php the_permalink(); ?>" alt="<?php the_title(); ?>">
