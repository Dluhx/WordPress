		...
		<div class="main-post-wrap">
			...
			<div class="post__text inverse-text max-width-sm">
				<?php  
					...
					if($category[0]){
					echo '<a class="post__cat post__cat--bg cat-theme-bg" href="'.get_category_link($category[0]->term_id ).'">'.$category[0]->cat_name.'</a>';
					};
				?>
		...
		<div class="sub-posts-wrap">
			<div class="sub-posts hidden-xs">
				<div class="row row--space-between">
					<?php query_posts('posts_per_page=4&ignore_sticky_posts=1&orderby=comment_count&offset=1'); ?>
					<?php while (have_posts()) : the_post(); ?>
