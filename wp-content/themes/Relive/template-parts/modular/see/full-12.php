...
<div class="<?php if( $id['modular_full_mobile'] ){ ?>mobile_modular_no <?php } ?>mnmd-block mnmd-block--fullwidth mnmd-mosaic mnmd-mosaic--gutter-10<?php if( $full_background_white ){?> relive_v3_bottom_0<?php }?>">
	<div class="container">
		...
		<div class="row row--space-between">
			<?php
				query_posts('posts_per_page=3&ignore_sticky_posts=1&meta_key=views&orderby=meta_value_num&order=DESC');
				$i = 1;
				while (have_posts()) : the_post();
			?>
			<?php if ( 1 === $i ) : ?>
			<div class="mosaic-item col-xs-12 col-md-8">
				<article class="post--overlay post--overlay-bottom post--overlay-floorfade post--overlay-padding-lg">
