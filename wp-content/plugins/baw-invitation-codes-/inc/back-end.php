...
function baweic_admin_menu() {
	// All my pages
	add_menu_page( __( 'Invitation Codes List', 'baweic' ), __( '邀请码', 'baweic' ), 'manage_options', 'baweic_list_codes', 'baweic_list_codes', 'dashicons-tickets', 30 );
	add_submenu_page( 'baweic_list_codes', __( 'Add new code', 'baweic' ), __( '新增邀请码', 'baweic' ), 'manage_options', 'baweic_add_code', 'baweic_add_code' );
	add_submenu_page( 'baweic_list_codes', __( 'Generate codes', 'baweic' ), __( '批量增加邀请码', 'baweic' ), 'manage_options', 'baweic_rand_code', 'baweic_rand_code' );
	add_submenu_page( 'baweic_list_codes', __( 'Codes list (raw)', 'baweic' ), __( '邀请码列表 (文本)', 'baweic' ), 'manage_options', 'baweic_raw_codes', 'baweic_raw_codes' );
	add_submenu_page( 'baweic_list_codes', __( 'Some options', 'baweic' ), __( '其他选项', 'baweic' ), 'manage_options', 'baweic_settings', 'baweic_settings_page' );
